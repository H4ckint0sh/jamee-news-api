...
const createTopic = (newTopicBody) => __awaiter(void 0, void 0, void 0, function* () {
    const { slug, description = "" } = newTopicBody;
    if (!slug) {
        throw new error_handling_1.HttpError(400, "Bad request");
    }
    const topic = yield models.Topic.create({
        slug: slug,
