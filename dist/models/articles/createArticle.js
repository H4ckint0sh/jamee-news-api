...
const createArticle = (articleBody) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { title, topic, author, body, article_img_url = defaultArticleUrl, } = articleBody;
    const newArticle = yield models.Article.create({
        title: title,
        topic: topic,
        author: author,
        body: body,
